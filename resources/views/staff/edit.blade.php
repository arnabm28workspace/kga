...
<section>   
    <ul class="breadcrumb_menu">        
        <li><a href="{{ route('staff.list') }}?{{$getQueryString}}">Staff</a> </li>
        <li>Update</li>
    </ul> 
    <div class="row">
        <div class="col-sm-12">
            <form id="myForm" action="{{ route('staff.update', [$idStr,$getQueryString]) }}" method="POST">                
                @csrf
                ...
                <div class="card shadow-sm">
                    <div class="card-body text-end">
                        <a href="{{route('staff.list')}}?{{$getQueryString}}" class="btn btn-sm btn-danger">Back</a>

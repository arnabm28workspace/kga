            ...
            <div class="card shadow-sm">
                <div class="card shadow-sm">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <p><span class="text-muted">Person Name : {{$customer->name}} </span> </p>
                        </div> 
                        <div class="form-group">
                            <p><span class="text-muted">Email : {{$customer->email}} </span> </p>
                        </div> 
                        <div class="form-group">
                            <p><span class="text-muted">Phone : {{$customer->phone}}  </span> </p>
                        </div> 
                        <div class="form-group">
                            <p><span class="text-muted">Address : {{$customer->address}} </span> </p>
                        </div> 
                    </div>
                </div>  
            </div>                                      
    ...
    <div class="row">
        <div class="col-md-12">
            <form id="myForm" action="{{ route('packingslip.save-invoice') }}" method="POST">
                ...
                <input type="hidden" name="customer_id" value="{{ $packingslip->sales_order->customer_id }}">
                <input type="hidden" name="customer_details[name]" value="{{ $customer->name }}">
                <input type="hidden" name="customer_details[email]" value="{{ $customer->email }}">
                <input type="hidden" name="customer_details[phone]" value="{{ $customer->phone }}">
                <input type="hidden" name="customer_details[address]" value="{{ $customer->address }}">
                @php                    
                    $total_amount = 0;
                @endphp
            <h6>Item Details</h6>

                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="pan_no" placeholder="PAN" class="form-control" maxlength="11" value="{{$data->pan_no}}">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="gst_no" placeholder="GST No" class="form-control" maxlength="20" value="{{$data->gst_no}}">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="license_no" placeholder="License No" class="form-control" maxlength="20" value="{{$data->license_no}}">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="address" placeholder="Address" class="form-control" maxlength="200" value="{{$data->address}}">

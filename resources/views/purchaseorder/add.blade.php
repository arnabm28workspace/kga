                        ...
                        <table class="table" id="timePriceTable">
                            ...
                            <tbody> 
                                ...
                                <tr id="tr_{{$key}}" class="tr_pro">
                                    <td class="f-12">
                                        <input type="text" class="form-control" id="product{{$key}}" onkeyup="getProducts(this.value,{{$key}},'{{$type}}');" placeholder="Search product ... " name="details[{{$key}}][product]" value="{{ old('details.'.$key.'.product') }}" style="width: 200px">
                                    ...
                                    <td>
                                        <div class="input-group ">
                                            ...
                                            <input type="text" name="details[{{$key}}][mop]" class="form-control" readonly id="mop{{$key}}" value="{{ old('details.'.$key.'.mop') }}" style="width: 90px;">
                                        </div>
                                    </td>
                                    @if ($type == 'sp')
                                    <td>                                    
                                    ...
                                    <td>
                                        <div class="input-group ">
                                            ...
                                            <input type="text" onkeypress="validateNum(event)" class="form-control" id="cost_price{{$key}}" placeholder="" name="details[{{$key}}][cost_price]" onkeyup="calculatePrice({{$key}})" value="{{ old('details.'.$key.'.cost_price') }}">
                                        </div>
                                        @error('details.'.$key.'.cost_price') <p class="small text-danger">{{ $message }}</p> @enderror
                                    </td>                                
                                    <td>
                                        <input type="text" name="details[{{$key}}][hsn_code]" class="form-control" id="hsn_code{{$key}}" maxlength="6" value="{{ old('details.'.$key.'.hsn_code') }}" style="width: 90px;">
                                    ...
                                    <td>
                                        <div class="input-group ">
                                            ...
                                            <input type="text" onkeypress="validateNum(event)" class="form-control" id="mrp{{$key}}" placeholder="" name="details[{{$key}}][mrp]" value="{{ old('details.'.$key.'.mrp') }}" style="width: 90px;">
                                        </div>
                                        @error('details.'.$key.'.mrp') <p class="small text-danger">{{ $message }}</p> @enderror
                                    </td>
                                    <td>
                                        <div class="input-group ">
                                            <input type="text" onkeypress="validateNum(event)" class="form-control" id="tax{{$key}}" placeholder="" name="details[{{$key}}][tax]" value="{{ old('details.'.$key.'.tax') }}" maxlength="2" style="width:90px;">
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">
                                                    %
                                                </div>
                                    ...
                                    <td>
                                        <div class="input-group ">
                                            ...
                                            <input type="text" name="details[{{$key}}][total_price]" class="form-control total_price" id="total_price{{$key}}" value="{{ old('details.'.$key.'.total_price') }}" readonly style="width: 90px;">
                                        </div>
                                ...
                                <tr id="tr_1" class="tr_pro">
                                    <td class="f-12">
                                        <input type="text" class="form-control" id="product1" onkeyup="getProducts(this.value,1,'{{$type}}');" placeholder="Search product ... " name="details[1][product]" style="width: 200px">
                                    ...
                                    <td>
                                        <div class="input-group ">
                                            ...
                                            <input type="text" name="details[1][mop]" class="form-control" readonly id="mop1" style="width: 90px;">
                                        </div>
                                    </td>
                                    @if ($type == 'sp')
                                    <td>
                                    ...
                                    <td>                                    
                                        <div class="input-group ">
                                            ...
                                            <input type="text" onkeypress="validateNum(event)" class="form-control" id="cost_price1" placeholder="" name="details[1][cost_price]" onkeyup="calculatePrice(1)">
                                        </div>
                                    </td>
                                    <td>
                                        <input type="text" name="details[1][hsn_code]" class="form-control" id="hsn_code1" maxlength="6" style="width: 90px;">
                                    </td>
                                    <td>                                    
                                        <div class="input-group ">
                                            <div class="input-group-prepend">
                                            ...
                                            <input type="text" onkeypress="validateNum(event)" class="form-control" id="mrp1" placeholder="" name="details[1][mrp]" style="width: 90px;">
                                        </div>
                                    </td>
                                    <td>
                                        <div class="input-group ">
                                            <input type="text" onkeypress="validateNum(event)" class="form-control" id="tax1" placeholder="" name="details[1][tax]" maxlength="2" style="width:90px;">
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">
                                                    %
                                                </div>
                                    ...
                                    <td>                                    
                                        <div class="input-group ">
                                            ...
                                            <input type="text" name="details[1][total_price]" class="form-control total_price" id="total_price1" readonly style="width: 90px;">
                                        </div>
                                    </td>
                                    <td>
    ...
    $(document).on('click','.addNewTime',function(){
        ...
        if(type == 'fg'){
            ...
            <tr id="tr_`+i+`" class="tr_pro">
                <td class="f-12">
                    <input type="text" class="form-control" id="product`+i+`" placeholder="Search product ... " onkeyup="getProducts(this.value,`+i+`,'{{$type}}');" name="details[`+i+`][product]" style="width: 200px">
                ...
                <td>                
                    <div class="input-group mb-3">
                        ...
                        <input type="text" name="details[`+i+`][mop]" class="form-control" readonly id="mop`+i+`" style="width: 90px;">
                    </div>
                </td>
                <td>
                ...
                <td>                
                    <div class="input-group">
                        ...
                        <input type="text" onkeypress="validateNum(event)" class="form-control" id="cost_price`+i+`" placeholder="" name="details[`+i+`][cost_price]" onkeyup="calculatePrice(`+i+`)">
                    </div>
                </td>
                <td>
                    <input type="text" name="details[`+i+`][hsn_code]" class="form-control" id="hsn_code`+i+`" maxlength="6" style="width: 90px;">
                </td>
                <td>                
                    <div class="input-group">
                        <div class="input-group-prepend">
                        ...
                        <input type="text" onkeypress="validateNum(event)" class="form-control" id="mrp`+i+`" placeholder="" name="details[`+i+`][mrp]" style="width: 90px;">
                    </div>
                </td>
                <td>
                    <div class="input-group">
                        <input type="text" class="form-control" name="details[`+i+`][tax]" id="tax`+i+`" value="" maxlength="2" style="width:90px;">
                        <div class="input-group-prepend">
                            <div class="input-group-text" >
                                %
                            </div>
                ...
                <td>                
                    <div class="input-group">
                        ...
                        <input type="text" name="details[`+i+`][total_price]" class="form-control total_price" id="total_price`+i+`" readonly style="width: 90px;">
                    </div>
                </td>
                <td>
            ...
            <tr id="tr_`+i+`" class="tr_pro">
                <td class="f-12">
                    <input type="text" class="form-control" id="product`+i+`" placeholder="Search product ... " onkeyup="getProducts(this.value,`+i+`,'{{$type}}');" name="details[`+i+`][product]">
                    <input type="hidden" name="details[`+i+`][product_id]" id="product_id`+i+`" class="productids">
                    <input type="hidden" name="details[`+i+`][product_unique_id]" id="product_unique_id`+i+`" >
                    <div class="respDrop" id="respDrop`+i+`"></div>
                </td>
                <td>                
                    <div class="input-group mb-3">
                        ...
                        <input type="text" name="details[`+i+`][mop]" class="form-control" readonly id="mop`+i+`" style="width: 70px;">
                    </div>
                </td>
                <td>

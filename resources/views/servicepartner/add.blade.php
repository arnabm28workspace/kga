                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="company_name" placeholder="Please Enter Company Name" class="form-control" maxlength="100" value="{{old('company_name')}}">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="person_name" placeholder="Please Enter Person Name" class="form-control" maxlength="100" value="{{old('person_name')}}">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="email" placeholder="Please Enter Email Address" class="form-control" maxlength="100" value="{{old('email')}}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="phone" placeholder="Please Enter Phone Number" class="form-control" maxlength="10" value="{{old('phone')}}">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="pan_no" maxlength="11" placeholder="Please Enter PAN Number" class="form-control" maxlength="100" value="{{old('pan_no')}}">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="aadhaar_no" maxlength="20" placeholder="Please Enter Aadhaar Number" class="form-control" maxlength="10" value="{{old('aadhaar_no')}}">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="gst_no" maxlength="20" placeholder="Please Enter GST Number" class="form-control" maxlength="10" value="{{old('gst_no')}}">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="license_no" placeholder="Please Enter License Number" class="form-control" maxlength="20" value="{{old('license_no')}}">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="salary" placeholder="Please Enter Salary" class="form-control" maxlength="100" value="{{old('salary')}}">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="repair_charge" placeholder="Please Enter Repair Charge" class="form-control" maxlength="100" value="{{old('repair_charge')}}">
                        ...
                        <div class="col-md-4">  
                            <div class="form-group">
                                ...
                                <input type="text" name="travelling_allowance" placeholder="Please Enter Travelling Allowance" class="form-control" maxlength="10" value="{{old('travelling_allowance')}}">

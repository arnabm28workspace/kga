                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" name="title" id="name" placeholder="Enter title" value="{{ old('title') }}" maxlength="100">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="public_name" id="public_name" placeholder="Please Enter Public Name" class="form-control" maxlength="100" value="{{old('public_name')}}">
                    ...
                    <div class="row">     
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select name="service_level" class="form-control" id="">
                                    ...
                                    <option value="customer_level" @if(old('service_level') == 'customer_level') selected @endif>Customer</option>
                                    <option value="dealer_level" @if(old('service_level') == 'dealer_level') selected @endif>Dealer</option>
                                </select>
                        ...
                        <div class="col-md-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="1" id="is_installable" name="is_installable">
                        ...
                        <div class="col-md-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="1" id="is_amc_applicable" name="is_amc_applicable">
                    ...
                    <div class="row">  
                        ...
                        <div class="col-md-3" id="warranty_div">
                            <div class="form-group">
                                ...
                                <input type="text" name="warranty_period" class="form-control" value="{{ old('warranty_period') }}" id="">                                
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" name="mop" id="mop" placeholder="Enter Market Operating Price" value="{{ old('mop') }}" onkeypress="validateNum(event)" maxlength="8">
                                </div>

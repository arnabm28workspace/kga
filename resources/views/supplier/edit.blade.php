                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="public_name" placeholder="Please Enter Public Name" class="form-control" maxlength="100" value="{{$data->public_name}}">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="email" placeholder="Please Enter Email" class="form-control" maxlength="100" value="{{$data->email}}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="phone" placeholder="Please Enter Phone" class="form-control" maxlength="10" value="{{$data->phone}}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">  
                            <div class="form-group">
                                ...
                                <input type="text" name="pin" placeholder="Please Enter PIN Code" class="form-control" maxlength="10" value="{{$data->pin}}">
